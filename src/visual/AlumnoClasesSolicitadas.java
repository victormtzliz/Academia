...
public class AlumnoClasesSolicitadas extends JFrame {
	...
	/**
	 * Ordena de menor a mayor las clases a las que se han apuntado los alumnos
	 * y la cantidad
	 * 
	 * @param arrayInput
	 *            arrayList de la cantidad de veces de cada clase a la que se
	 *            han apuntado
	 * @param clases
	 *            arrayList de las clases a las que se han apuntado los alumnos
	 ...
	 * 
	 * @param left
	 *            parte izda del arrayList de la cantidad de clases de los
	 *            alumnos
	 * @param right
	 *            parte dcha del arrayList de la cantidad de clases de los
	 *            alumnos
	 * @param leftC
	 *            parte izda del arrayList de las clases a las que se han
	 *            apuntado los alumnos
	 * @param rightC
	 *            parte dcha del arrayList de las clases a las que se han
	 *            apuntado los alumnos
	 * @return devuelve ordenada la cantidad, es un arrayList
	 */
	 ...
	 * @throws AdiministradorNoEcontrado
	 *             la clase que salta la excepcion si el usuario no existe
	 */
